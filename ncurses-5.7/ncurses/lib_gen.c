...
{
	T((T_CALLED("attroff(%s)"), _traceattr2(0,z))); returnCode(wattr_off(stdscr, (attr_t)(z), 
# 45 "_6245.c" 3 4
 ((void *)0)
# 45 "_6245.c"
));
...
{
	T((T_CALLED("attron(%s)"), _traceattr2(0,z))); returnCode(wattr_on(stdscr, (attr_t)(z), 
# 52 "_6245.c" 3 4
 ((void *)0)
# 52 "_6245.c"
));
...
{
	T((T_CALLED("wattron(%p,%d)"), a1, z)); returnCode(wattr_on(a1, (attr_t)(z), 
# 723 "_6245.c" 3 4
 ((void *)0)
# 723 "_6245.c"
));
...
{
	T((T_CALLED("wattroff(%p,%d)"), a1, z)); returnCode(wattr_off(a1, (attr_t)(z), 
# 730 "_6245.c" 3 4
 ((void *)0)
# 730 "_6245.c"
));
